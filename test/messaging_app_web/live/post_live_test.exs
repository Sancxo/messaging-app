defmodule MessagingAppWeb.PostLiveTest do
  use MessagingAppWeb.ConnCase

  import Phoenix.LiveViewTest

  alias MessagingApp.Flux

  @create_attrs %{likes_count: 42, message: "some message", reposts_count: 42, username: "some username"}
  ...
  defp fixture(:post) do
    {:ok, post} = Flux.create_post(@create_attrs)
    post
  end
